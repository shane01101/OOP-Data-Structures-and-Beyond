...
public class NearbyWords implements SpellingSuggest {
	...
	public void insertions(String s, List<String> currentList, boolean wordsOnly ) 
	{
		...
		// for each letter in s + 1 and for all possible insertion characters
		for(int index = 0; index <= s.length(); index++)
		{
			for(int charCode = (int)'a'; charCode <= (int)'z'; charCode++) 
			{
	...
	{
		// TODO: Implement this method
		// for each letter in s and for all possible deletion characters
		for(int index = 0; index < s.length(); index++)
		{
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		// initial variables
		List<String> theQueue = new LinkedList<String>();     // String to explore
		...
		while(!theQueue.isEmpty() && retList.size() < numSuggestions)
		{
			String cur = theQueue.remove(0);
			//visited.add(cur);
